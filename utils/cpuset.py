...
class ServerCpuSet(object):
    ...
    def get_closest_available_cpus(self, available_list : list, allocated_list : list):
        ...
        """
        cpuid_dict = {cpu.get_cpu_id():cpu for cpu in self.get_cpu_list()}
    ...
    def __get_available_cpus_with_weight(self, from_list : list, to_list : list, exclude_max : bool = True):
        ...
        for available_cpu in from_list:
            ...
            for subset_cpu in to_list:
                ...
                distance = self.get_distance_between_cpus(subset_cpu, available_cpu)
